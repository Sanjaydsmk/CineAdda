...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 w-full flex justify-between items-center px-6 md:px-16 lg:px-36 z-50'>
      <Link to='/' className='max-md:flex-1'> <img src={assets.logo} alt="" className='w-45 h-auto' />
...
{
  !user ? ( <button onClick={openSignIn} className='px-4 py-1 sm:px-7 sm:py-2 bg-primary hover:bg-primary-dull rounded-full 
